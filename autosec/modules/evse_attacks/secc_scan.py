...
# Verify the path and structure
print("sys.path:", sys.path)
print("Directory contents:", os.listdir(root_dir))
...
# Define the UDP client class for communication
...
# Define the Autosec module class
