...
/* ------------------------------------------------------------ */
/*** CAN_Configure_Adaptive_Spoofing(PmodCAN *InstancePtr, u8 mode, u32 identifier, u8 ide)
**
**   Synopsis:
**      Configures the PmodCAN using a SPI transfer for Adaptive Spoofing
**
**   Parameters:
**      InstancePtr: The PmodCAN object to communicate with
**      mode:
**      identifier: Identifier used for the Acceptance Filter
**      ide: Indicates wether we use Normal or extended identifier
**
**   Return Values:
**      void
**
...
/* ------------------------------------------------------------ */
/*** CAN_PrepareMessage(PmodCAN *InstancePtr, CAN_Message message,
**         CAN_TxBuffer target)
**
**   Synopsis:
**      Prepares message without sending it
**
**   Parameters:
**      InstancePtr: The PmodCAN object to communicate with
**      message:
